...
?>
        ...
        <h2>Presensi  Office Administration</h2>
...
<script>
    ...
    $(document).ready(function () {
         $("#hasilpresensi").load('read-office.php')
        var video =
                        ...
                        success: function(data) {
                            ...
                            if ($.trim(data) == "berhasil") {
                                ...
                                $.toaster({
                                    ...
                                    // toast message
                                    message : 'Presensi Gagal, Ada masalah System, harap hubungi pengurus',
